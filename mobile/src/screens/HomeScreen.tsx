            ...
            <SafeAreaView style={styles.safe}>
                ...
                <View style={styles.center}>
                    ...
                    <View style={styles.buttonArea}>
                        ...
                        <TouchableOpacity onPress={handlePress} activeOpacity={0.85} style={[styles.micButton, isListening && styles.micButtonActive]}>
                            {isListening ? (
                    ...
                    {/* Status */}
                    <Text style={styles.statusText}>{isListening ? "Listening..." : "Tap to talk"}</Text>
                    <Text style={styles.statusSubtext}>{isListening ? "Speak naturally, I'm listening" : "Press the button and start talking"}</Text>
                </View>
                ...
                <View style={styles.bottomCard}>
                    ...
                    <Text style={styles.bottomHint}>Ask me anything — check your schedule, take your medications, or just chat.</Text>
                </View>
            </SafeAreaView>
        </LinearGradient>
    );
